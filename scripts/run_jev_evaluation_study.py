...
def main(run_id: str, repeats: int, ablation_sample_size: int, seed: int, max_workers: int, dry_run: bool) -> None:
...
if __name__ == "__main__":
    ...
    main(args.run_id, args.repeats, args.ablation_sample_size, args.seed, args.max_workers, args.dry_run)
